...
- **OS Flights**: flight preparation, import, replay, logbook, maintenance,
...
Items 2 through 6 are now implemented in the OS Flights Lab migration.
...
When Exopter needs a public page, it should inherit the OS Flights Lab
