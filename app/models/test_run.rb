class TestRun < ApplicationRecord
  ...
  before_update :prevent_changes_when_validated
  before_destroy :prevent_changes_when_validated
  ...
  def prevent_changes_when_validated
    return true if attribute_in_database("validated_at").blank?

    errors.add(:base, "Validated test runs are immutable")
    throw(:abort)
  end
end
