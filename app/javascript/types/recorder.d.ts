...
export interface Recorder {device_id:string; connectivity_url:string; initialization_url:string; initialization_confirmed:boolean}
...
export interface Heartbeat {
  recorder:{device_id:string;firmware?:string;model?:string};
