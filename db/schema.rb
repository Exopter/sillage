...
ActiveRecord::Schema[8.1].define(version: 2026_07_29_090000) do
  ...
  create_table "operator_events", force: :cascade do |t|
    ...
    t.index ["signal_session_id"], name: "index_operator_events_on_signal_session_id"
  ...
  create_table "signal_batches", force: :cascade do |t|
    t.string "checksum"
    t.datetime "created_at", null: false
  ...
  create_table "signal_sessions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_signal_sessions_on_user_id"
