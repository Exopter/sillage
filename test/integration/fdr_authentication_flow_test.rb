...
class FdrAuthenticationFlowTest < ActionDispatch::IntegrationTest
  ...
  setup do
    @recorder = create_embedded_controller(assembly: Assembly.create!(name: "Authenticated recorder"), device_id: "ECU-A172E0")
  ...
  test "rejects malformed challenges and recorders without a key" do
    ...
    unclaimed = EmbeddedController.create!(device_id: "ECU-ABC123")
    post api_v1_fdr_authentication_path,
